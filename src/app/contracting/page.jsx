    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative py-28 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-amber-50">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <span className="inline-block px-4 py-1.5 bg-amber-100 text-amber-800 rounded-lg text-xs font-black mb-6">
            شركة الراية للمقاولات العامة والإنشاءات والتشطيب
          </span>
          ...
          <p className="text-gray-600 text-xl max-w-3xl mx-auto leading-relaxed font-medium mb-8">
            من أعمال الحفر وتأسيس العظم والخرسانة المسلحة، إلى أرقى تشطيبات السوبر ديلوكس وتسليم المفتاح. نلتزم بكود البناء الفلسطيني وبمعايير أمان هندسية مطلقة تضمن استثمارك العقاري في القدس، رام الله، وأريحا.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 bg-white">
        <div className="bg-gradient-to-br from-amber-50 via-white to-amber-50 border border-amber-200/80 p-8 md:p-12 rounded-[2.5rem] shadow-sm">
          <div className="max-w-5xl">
            ...
            <h3 className="text-2xl md:text-3xl font-black mb-4 text-slate-900">كيف نحدد تكلفة بناء العظم والتشطيب الفاخر في فلسطين؟</h3>
            
            {/* نص الـ SEO الثري والمكثف (+350 كلمة إضافية مدمجة بسلاسة لتوافق السيو والمقاولات) */}
            <p className="text-slate-600 text-sm md:text-base leading-relaxed mb-6 font-normal">
              تختلف تكلفة متر البناء في فلسطين بناءً على عدة محددات جغرافية وفنية؛ منها طبيعة التربة (صخرية تتطلب حفر كبيراً أم رملية بحاجة لقواعد شريطية معقدة)، والموقع الجغرافي ونظام البلديات في القدس أو رام الله وضواحيها، بالإضافة إلى درجة ونوع مواد التشطيب (ديلوكس، سوبر ديلوكس، أو تجاري). نحن في الراية نقدم دراسة جدوى فنية مجانية وحساب كميات دقيق يمنع الهدر المالي ويوفر عليك ما يصل إلى 15% من التكلفة الكلية للمواد.
              <br/><br/>
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-slate-900 mt-3 mb-2">أسئلة شائعة حول البناء والتعهدات بفلسطين</h2>
        ...
        <div className="space-y-4">
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
            ...
            <p className="text-slate-600 text-xs md:text-sm leading-relaxed font-normal">
              نحن نوفر عقوداً قانونية متكاملة تضمن جودة الاسمنت والحديد المسلح المعتمد من نقابة المهندسين ومختبرات فحص المواد الفلسطينية، مع الالتزام التام بالمخططات الهندسية المعمارية والإنشائية، وتأمين كادر عمالي ماهر ذو خبرة طويلة ببناء الفلل والإسكانات.
            </p>
          </div>

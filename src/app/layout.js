...
icons: {
  ...
  description:
    "منصة الراية العقارية لعرض أفضل الشقق للبيع والإيجار في القدس، كفر عقب، رام الله، وأريحا , رام الله , بيت حنينا , صور باهر , البوابه. اكتشف أحدث العقارات والمشاريع الاستثمارية بسهولة.",

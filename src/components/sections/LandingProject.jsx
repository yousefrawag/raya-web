...
const LandingProject = ({CurrentView}) => {
  const projects = [
    {
      id: 1,
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            مشاريع عقارية متميزة تجمع بين التصميم العصري والجودة العالية
          </p>
        </div>
        ...
        <div className={`grid ${CurrentView === "list"? "grid-cols-3 gap-8" : CurrentView === "module" ? "grid-cols-1 gap-8" : "lg:grid-cols-3 md:grid-cols-2 gap-8"}`}>
          ...
          <Link href="/projects" className="bg-gradient-to-r cursor-pointer from-slate-700 to-slate-800 hover:from-slate-800 hover:to-slate-900 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
